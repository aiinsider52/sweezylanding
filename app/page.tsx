        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex items-center gap-3">
              {/* X / Twitter */}
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/[0.04] border border-white/[0.06] hover:bg-white/[0.08] hover:border-white/[0.12] transition-all duration-300 text-white/40 hover:text-white">
          ...
          {columns.map((col) => (
            <div key={col.title} className="lg:col-span-2">
              <h4 className="text-sm font-semibold text-white/70 uppercase tracking-wider mb-5">{col.title}</h4>
              <ul className="space-y-3">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <a href={link.href} className="text-[15px] text-white/35 hover:text-white/70 transition-colors duration-300">
                      {link.label}
                    </a>
                  </li>
                ))}
          ...
          <div className="lg:col-span-4 md:col-span-2 lg:col-start-9">
            <div className="rounded-2xl bg-white/[0.03] border border-white/[0.06] p-6">
              ...
              <p className="text-sm text-white/35 mb-4">{t("footer.newsletterDesc")}</p>

...
const COPY: Record<Locale, any> = {
  en:{title:"Jobs in Switzerland, made easier to find",accent:"made easier",description:"Verified opportunities for international talent, newcomers and Ukrainians in Switzerland. Employers can submit a vacancy for review.",eyebrow:"SWEEZY JOBS · SWITZERLAND",post:"Post a vacancy",guide:"Job search guide",route:["Employer submits","Sweezy reviews","Candidate applies"],section:"Work that fits real life",sectionBody:"Clear location, workload, language and permit information before a candidate applies.",categories:[["Local roles","Hospitality, retail and services"],["Office & tech","Operations, product and support"],["Skilled work","Construction, logistics and care"],["Flexible","Part-time, hybrid and remote"]],openTitle:"Vacancy board opening",openBody:"First employer submissions are being reviewed. No scraped, expired or anonymous listings: only vacancies checked by Sweezy.",empty:"No verified vacancies published yet.",seo:"Jobs in Switzerland for expats and Ukrainians. Browse verified vacancies or post a job for review on Sweezy."},
  uk:{title:"Робота у Швейцарії, яку легше знайти",accent:"легше знайти",description:"Перевірені вакансії для українців, новоприбулих та міжнародних фахівців у Швейцарії. Роботодавці можуть подати вакансію на модерацію.",eyebrow:"SWEEZY JOBS · ШВЕЙЦАРІЯ",post:"Розмістити вакансію",guide:"Гід із пошуку роботи",route:["Роботодавець подає","Sweezy перевіряє","Кандидат відгукується"],section:"Робота для реального життя",sectionBody:"Місто, зайнятість, мови й вимоги до дозволу видно до відгуку.",categories:[["Локальна робота","Готелі, магазини та сервіси"],["Офіс і tech","Операції, product та support"],["Кваліфікована праця","Будівництво, логістика й догляд"],["Гнучкий формат","Part-time, hybrid та remote"]],openTitle:"Дошка вакансій відкривається",openBody:"Перші заявки роботодавців проходять перевірку. Без парсингу, прострочених чи анонімних оголошень — лише вакансії після модерації Sweezy.",empty:"Перевірених вакансій ще немає.",seo:"Вакансії у Швейцарії для українців і новоприбулих. Знайдіть роботу або розмістіть вакансію на Sweezy."},

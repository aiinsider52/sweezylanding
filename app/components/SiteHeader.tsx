...
const LABELS = {
  en: { home: "Home", guides: "Guides", places: "Places", planning: "Planning", jobs: "Jobs", community: "Community", blog: "Blog", app: "Get app", menu: "Open menu", close: "Close menu" },
  uk: { home: "Головна", guides: "Гіди", places: "Місця", planning: "Планування", jobs: "Робота", community: "Спільнота", blog: "Блог", app: "Завантажити", menu: "Відкрити меню", close: "Закрити меню" },
  de: { home: "Start", guides: "Guides", places: "Orte", planning: "Planung", jobs: "Jobs", community: "Community", blog: "Blog", app: "App laden", menu: "Menü öffnen", close: "Menü schließen" },
} as const;

  ...
  return (
    <div className="text-white">
      ...
      <section className="relative overflow-hidden py-24 sm:py-28">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(34,197,94,0.08),transparent_50%)]" />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {copy.whyItems.map((item, i) => (
              <article
                key={item.title}
                className="group relative overflow-hidden rounded-[1.75rem] border border-white/[0.06] bg-white/[0.025] p-7 sm:p-8 transition-colors duration-300 hover:border-accent-green/15 hover:bg-white/[0.04]"
              >
                <div className="absolute -top-16 -right-16 h-40 w-40 rounded-full bg-gradient-to-br from-accent-green/[0.07] to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />

                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-5">
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.06] to-white/[0.02] text-xl">
                      {WHY_ICONS[i]}
                    </div>
                    <span className="text-xs font-bold uppercase tracking-[0.25em] text-white/20">
                      0{i + 1}
                    </span>
                  </div>

...
export default function CookiesPage() {
  ...
  return (
    <main className="min-h-screen bg-dark-900 text-white relative overflow-hidden">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 h-[600px] w-[900px] rounded-full bg-gradient-to-br from-neon-purple/15 via-neon-blue/10 to-transparent blur-3xl opacity-40"
      />
      ...
      <article className="relative z-10 mx-auto max-w-4xl px-6 py-16 sm:py-24">
        ...
        >
          ...
          <p className="text-white/40 text-sm">{t("cookiesPage.lastUpdated")}</p>
        </motion.header>
        ...
        >
          ...
          <motion.section variants={fadeUp}>
            ...
            <p className="mb-4">{t("cookiesPage.s2Intro")}</p>
            ...
            <ul className="list-disc list-inside space-y-2 ml-2">
              <li>
                <strong className="text-white/80">
                  {t("cookiesPage.s3Item1Label")}
                </strong>{" "}
                {t("cookiesPage.s3Item1Text")}
              </li>
              <li>
                <strong className="text-white/80">
                  {t("cookiesPage.s3Item2Label")}
                </strong>{" "}
                {t("cookiesPage.s3Item2Text")}
              </li>
              <li>
                <strong className="text-white/80">
                  {t("cookiesPage.s3Item3Label")}
                </strong>{" "}
                {t("cookiesPage.s3Item3Text")}
              </li>
            </ul>
          </motion.section>
          ...
          <motion.section variants={fadeUp}>
            ...
            <p>
              {t("cookiesPage.s5Text")}{" "}
              <a
                href={`mailto:${t("cookiesPage.email")}`}

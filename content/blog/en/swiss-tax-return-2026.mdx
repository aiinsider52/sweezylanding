...
description: "Do you need to file a Swiss tax return? Check the CHF 120,000 rule, March 31 Quellensteuer deadline, deductions and canton-specific filing dates."
publishedAt: "2026-03-27"
updatedAt: "2026-09-02"
author: "Sweezy Team"
reviewedAt: "2026-09-02"
effectiveDate: "2026-09-02"
summaryAnswer: "Whether you must file depends on permit, income, assets, other income and canton. For employees taxed at source, CHF 120,000 gross employment income triggers mandatory subsequent ordinary assessment; a voluntary request generally must reach the competent canton by March 31 of the following tax year. Ordinary return deadlines are canton-specific."
appliesTo: "Foreign employees and residents deciding whether to file or request subsequent ordinary assessment for tax year 2025 in 2026."
jurisdiction: "Swiss federal framework plus cantonal filing deadlines, deductions, forms and assessment practice."
officialSources:
  - name: "Federal Tax Administration — withholding tax"
    url: "https://www.estv.admin.ch/de/quellensteuer"
  - name: "Federal Tax Administration — questions and answers"
    url: "https://www.estv.admin.ch/de/fragen-und-antworten"
  - name: "Federal Tax Administration — taxation at source dossier"
    url: "https://www.estv.admin.ch/dam/estv/de/dokumente/estv/steuersystem/dossier-steuerinformationen/e/e-besteuerung-an-der-quelle.pdf.download.pdf/e-besteuerung-an-der-quelle.pdf"
...
changeLog:
  - date: "2026-09-02"
    note: "Reverified the CHF 120,000 mandatory assessment threshold and non-extendable March 31 voluntary request deadline; tested a clearer search-result promise without changing URL or canonical."
  - date: "2026-08-03"
    note: "Separated the March 31 Quellensteuer assessment deadline from canton-specific ordinary tax-return deadlines and strengthened filing intent."
  - date: "2026-07-14"
    note: "Added federal tax and social-insurance sources."
keywords:
...
# Swiss Tax Return 2026: Who Must File, Deadlines & Deductions
...
Need the system overview first? Read our guide to the [Swiss tax system for expats](/en/blog/swiss-tax-system-expats). This page focuses on the practical filing decision, deadlines and documents.
...
- Are a **Swiss citizen**
- Are a Swiss-resident employee taxed at source with **at least CHF 120,000 annual gross employment income**
- Meet your canton's thresholds for **other income or taxable assets** not covered by withholding tax

Wanting additional deductions is a reason to request a **voluntary** subsequent ordinary assessment, not by itself a mandatory-filing category. Check the full calculation first: an assessment can increase or reduce the final bill.

### Quellensteuer applies if you:

- Are a foreign employee resident in Switzerland without a C permit, subject to the applicable exceptions

Your employer deducts Quellensteuer from salary. Crossing the CHF 120,000 threshold does not itself stop these deductions: tax already withheld is credited in subsequent ordinary assessment. Other income, assets and personal circumstances can also trigger filing. [Zurich's tax authority explains the assessment rules](https://www.zh.ch/de/steuern-finanzen/steuern/quellensteuer/Quellensteuerpflichtige-Personen.html); canton-specific thresholds must not be applied nationwide.

**Do not confuse two deadlines.** A request for subsequent ordinary assessment under Quellensteuer generally must reach the competent cantonal authority by **31 March 2026** for tax year 2025. The deadline for an ordinary tax return is set by the canton and may differ; check the date printed by your cantonal tax authority and request any extension there.
...
- Standard allowances in withholding tariffs may differ from the deductions available in ordinary assessment
...
Submit the request to your cantonal tax authority (Steueramt). In some cantons, you can do this online. For Swiss residents, subsequent ordinary assessment continues in later years while source-tax liability continues; it is not a one-year trial.
...
The maximum deductible contribution for 2026 is **CHF 7,258** for employees who belong to a pension fund. For people without a pension fund, the maximum is 20% of earned income, capped at CHF 36,288. Contributions are deductible subject to the applicable tax rules.
...
- [Federal Tax Administration: Swiss withholding tax](https://www.estv.admin.ch/de/quellensteuer)
...
Rules and filing tools vary by canton. Confirm deadlines and required forms with your cantonal tax authority before submitting.

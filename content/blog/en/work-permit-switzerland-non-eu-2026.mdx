...
summaryAnswer: "A non-EU/EFTA job offer does not by itself authorize work in Switzerland. The employer normally files the permit application and must demonstrate admission criteria including qualifications, labour-market priority, customary salary and available quota. Work may start only after required authorization and registration."
appliesTo: "Qualified non-EU/EFTA nationals seeking employment in Switzerland; separate rules apply to EU/EFTA citizens, Status S holders and some family members."
jurisdiction: "Federal FNIA/ASEO admission rules, assessed through cantonal labour-market and migration authorities plus SEM where required."
officialSources:
  - name: "SEM — non-EU/EFTA nationals"
    url: "https://www.sem.admin.ch/sem/en/home/themen/arbeit/nicht-eu_efta-angehoerige.html"
  - name: "SEM — basis for labour-market admission"
    url: "https://www.sem.admin.ch/sem/en/home/themen/arbeit/nicht-eu_efta-angehoerige/grundlagen_zur_arbeitsmarktzulassung.html"
  - name: "Federal Council — 2026 work-permit quotas"
    url: "https://www.admin.ch/it/newnsb/7HwBjdg5HpBA"
changeLog:
  - date: "2026-08-03"
    note: "Rechecked 2026 quotas and clarified that UK quotas are separate from third-country quotas."
keywords:
...
UK nationals are handled through separate quotas following Brexit. The 3,500 UK permits are additional to the 8,500 permits for qualified workers and specialists from other third countries.

**Practical implication**: quotas are one admission condition, not a first-come guarantee. Recent federal reporting says the quotas have not generally been fully used, but each application still needs to satisfy qualification, labour-market priority, salary and economic-interest requirements.
